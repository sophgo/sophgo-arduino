...
#elif defined (ARDUINO_ARCH_SG200X)
  #include "Processors/TFT_eSPI_Duo.c"
#else
...
#if !defined (ESP32) && !defined(TFT_PARALLEL_8_BIT) && !defined(ARDUINO_ARCH_RP2040) && !defined (ARDUINO_ARCH_MBED) && !defined (ARDUINO_ARCH_SG200X)
...
#else
  #if !defined(TFT_PARALLEL_8_BIT) && !defined(RP2040_PIO_INTERFACE)
    #if defined (TFT_MOSI) && !defined (TFT_SPI_OVERLAP) && !defined(ARDUINO_ARCH_RP2040) && !defined (ARDUINO_ARCH_MBED) //&& !defined (ARDUINO_ARCH_SG200X)
...
void TFT_eSPI::drawPixel(int32_t x, int32_t y, uint32_t color)
{
  ...
  // write to RAM
  DC_C; tft_Write_8(TFT_RAMWR);
  #if defined(TFT_PARALLEL_8_BIT) || defined(TFT_PARALLEL_16_BIT) || !defined(ESP32) || !defined(ARDUINO_ARCH_SG200X)
